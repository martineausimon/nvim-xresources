...
M.loadEditor = function()
  return {
    ...
    ErrorMsg                 = { guifg = C.light_red, guibg = C.none, gui = 'bold', guisp = nil },
...
M.loadTreesitter = function()
  return {
    ...
    ['@keyword']                = 'Keyword',
    ['@keyword.function']       = { guifg = C.light_yellow, guibg = C.none, gui = 'bold', guisp = nil },
    ['@keyword.operator']       = { guifg = C.yellow, guibg = C.none, gui = "bold", guisp = nil },
    ['@keyword.return']         = '@keyword.function',
    ['@conditional']            = { guifg = C.yellow, guibg = C.none, gui = 'bold', guisp = nil },
    ['@repeat']                 = 'Repeat',
    ['@debug']                  = 'Debug',
    ['@label']                  = 'Label',
    ['@include']                = 'Include',
