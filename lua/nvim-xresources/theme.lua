...
M.loadEditor = function()
  return {
    ...
    SpellBad                 = { guifg = nil, guibg = C.none, gui = 'undercurl', guisp = C.light_red },
    SpellCap                 = { guifg = nil, guibg = C.none, gui = 'undercurl', guisp = C.light_blue },
    SpellLocal               = { guifg = nil, guibg = C.none, gui = 'undercurl', guisp = C.light_cyan },
    SpellRare                = { guifg = nil, guibg = C.none, gui = 'undercurl', guisp = C.light_magenta },
...
M.loadPlugins = function()
  return {
    ...
    TelescopePreviewBorder = { guifg = C.yellow, guibg = C._bg, gui = nil, guisp = nil },
...
M.loadTreesitter = function()
  return {
    ...
    ["@macro"]                        = 'Macro',
    ["@markup.danger"]                  = 'ErrorMsg',
    ["@markup.danger.comment"]          = { guifg = C.fg1, guibg = C.red, gui = C.bold, guisp = nil },
    ["@markup.diff.add"]                = { guifg = C.light_cyan, guibg = C.none, gui = nil, guisp = nil },
    ["@markup.diff.delete"]             = { guifg = C.light_yellow, guibg = C.none, gui = nil, guisp = nil },
    ...
    ["@markup.link"]                  = "SpecialChar",
    ["@markup.link.url"]              = "markdownurl",
    ["@markup.list"]                  = 'Delimiter',
    ["@markup.literal"]                 = 'String',
    ["@markup.math"]                    = 'Special',
    ["@markup.note"]                    = 'SpecialComment',
    ["@markup.note.comment"]            = { guifg = C.magenta, guibg = C.none, gui = C.bold, guisp = nil },
    ["@markup.quote.markdown"]        = { guifg = C.light_cyan, guibg = nil, gui = nil, guisp = nil },
    ["@markup.raw"]                   = "markdowncode",
    ["@markup.reference"]               = 'Constant',
    ["@markup.strike"]                  = { guifg = C.none, guibg = C.none, gui = 'strikethrough', guisp = nil },
    ["@markup.strong"]                = { guifg = C.none, guibg = C.none, gui = C.bold, guisp = nil },
    ["@markup.todo"]                    = 'Todo',
    ["@markup.underline"]               = { guifg = C.none, guibg = C.none, gui = 'underline', guisp = nil },
    ["@markup.uri"]                     = 'Underlined',
    ["@markup.warning"]                 = 'WarningMsg',
